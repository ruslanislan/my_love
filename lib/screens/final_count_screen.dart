...
class FinalCountScreen extends StatefulWidget {
  const FinalCountScreen({Key? key, required this.asset, required this.dateTime}) : super(key: key);
  final String asset;
  final DateTime dateTime;

  @override
  State<FinalCountScreen> createState() => _FinalCountScreenState();
}

class _FinalCountScreenState extends State<FinalCountScreen> {
